...
export default function ColorCard({
  ...
  function getContrastBG(rStr: string, gStr: string, bStr: string) {
    const r = Math.max(0, Math.min(255, parseInt(rStr, 10) || 0));
    const g = Math.max(0, Math.min(255, parseInt(gStr, 10) || 0));
    const b = Math.max(0, Math.min(255, parseInt(bStr, 10) || 0));
    const brightness = (r * 299 + g * 587 + b * 114) / 1000;
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          {hasVideo && imageurl ? (
            ...
            <div
              className="absolute inset-0 rounded-xl bg-center bg-cover b"
              style={{
                background: imageurl
                  ? `url("/thumbs/${name}.png") center/cover no-repeat`
                  : `rgb(${red}, ${green}, ${blue})`,
          ...
          {hasVideo && (
            ...
            >
              <div
                ...
                style={{
                  boxShadow: "0px 0px 42px 15px rgba(0,0,0,0.2)",
                }}
              >
                <svg
        ...
        <div className="flex flex-col py-2">
          <p
            className="font-bold leading-5 text-2xl"
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent
          className="max-w-[75vw] sm:max-w-lg md:max-w-md p-0"
            ...
            <div className="px-6 py-4 pt-12">
              ...
              >
                <div className="flex flex-wrap gap-3 justify-center">
                  <Button
                    id="writestory"
                    className={`border rounded-full bg-white cursor-pointer`}
                    style={{
                      color: textColor,
